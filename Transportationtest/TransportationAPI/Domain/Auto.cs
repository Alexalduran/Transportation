...
namespace TransportationAPI.Domain
{
    public class Auto : ITransportation
    {
        public string Name { get; set; }
        public TType TransportType { get { return TType.Auto; } }
        public string TypeOfTransportString
        {
            get
            {
